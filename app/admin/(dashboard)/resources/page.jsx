...
export default function AdminResourcesManagerPage() {
  ...
  const categories = ['ALL', 'BUSINESS & LEADERSHIP', 'LIFE & STRATEGY', 'BRANDING & DIGITAL', 'REAL ESTATE', 'FINANCIAL LITERACY'];
    ...
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <div style={{ marginBottom: '0.35rem' }}>
            <span className="editorial-stamp">KNOWLEDGE FRAMEWORKS</span>
          </div>
          <h1
            style={{
          ...
          >
            Resources & Strategic Downloads
          </h1>
        </div>

        <Link href="/admin/resources/editor" className="btn btn-primary" style={{ padding: '0.65rem 1.25rem', fontSize: '0.85rem', gap: '0.45rem' }}>
          <Plus size={15} />
      ...
      >
        ...
        <div style={{ position: 'relative', minWidth: '280px', flex: '1 1 300px' }}>
          <input
            type="text"
            placeholder="Search frameworks by title or takeaway..."
            value={search}
        ...
        {loading ? (
          ...
          <div style={{ padding: '3rem', textAlign: 'center' }}>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', marginBottom: '1rem' }}>
              No frameworks match your current search or category filter.
            </p>
            <Link href="/admin/resources/editor" className="btn btn-editorial" style={{ display: 'inline-flex' }}>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--text-deep-blue)', lineHeight: 1.5, marginBottom: '1.5rem' }}>
              Are you sure you want to permanently delete <strong>&quot;{deleteModalResource.title}&quot;</strong>?
            </p>
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
              ...
              <button
                type="button"
                disabled={deletingId === deleteModalResource.id}
                onClick={() => handleDelete(deleteModalResource.id)}
                className="btn btn-primary"
                style={{ padding: '0.55rem 1rem', fontSize: '0.82rem', backgroundColor: 'var(--accent-red)' }}
              >
                {deletingId === deleteModalResource.id ? 'Deleting...' : 'Delete Resource'}
              </button>
            </div>
          </div>
        </div>
